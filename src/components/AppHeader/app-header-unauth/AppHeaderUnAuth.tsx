...
import { HeaderDesktopNav } from '@/components/AppHeader/app-header-unauth/HeaderDesktopNav'
import { HeaderMobileNav } from '@/components/AppHeader/app-header-unauth/HeaderMobileNav'
...
export const AppHeaderUnAuth: FC<Props> = observer(({ testId = 'header', ...rest }) => {
